																				...
																				return (
																					<Menu.Item
																						...
																						onClick={() => {
																							...
																							})('curl -X POST -H \"Content-Type: application/json\" --header \"token: ' + token + '\" --data \"' + JSON.stringify(JSON.parse($("#user_input").val())).replace(/"/gi,"\\\"") + '\" ' + window.location.protocol + "//" + window.location.host + '/api/program/' + this.props.CanvasReducer._id);
