												...
												<div>
													<Button
														onClick={() => {
															...
															})('curl -X POST -H \"Content-Type: application/json\" --header \"token: ' + token + '\" --data \'{}\' ' + window.location.protocol + "//" + window.location.host + '/api/program/' + this.state.program_info._id);
